...
<div class="soubg">
	<div class="sou">
        <span class="fr">
        	<span class="fl">你好，请<a href="pages/admin/Login.jsp">登录</a></span>
...
<div class="log_bg">	
    <div class="top">
        <div class="logo"><a href="pages/admin/Index.jsp"><img src="resources/images/logo.png" /></a></div>
    </div>
	<div class="login">
		...
		<div class="log_c">
            ...
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="70">
                <td>用户名</td>
                <td><input type="text" value="" class="l_user" name="adminName"/><span id="aa"></span></td>
              </tr>
              <tr height="70">
                <td>密&nbsp; &nbsp; 码</td>
