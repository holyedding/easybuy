...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <![endif]-->    
    <script type="text/javascript" src="resources/easybuy/js/jquery-1.11.1.min_044d0927.js"></script>
	<script type="text/javascript" src="resources/easybuy/js/jquery.bxslider_e88acd1b.js"></script>
    ...
    <script type="text/javascript" src="resources/easybuy/js/milk_ban.js"></script>
    <script type="text/javascript" src="resources/easybuy/js/paper_ban.js"></script>
    <script type="text/javascript" src="resources/easybuy/js/baby_ban.js"></script>
...
<div class="i_bg">
    ...
    <div class="content mar_15">
    	<ul class="cate">
        	<li><a href="pages/front/CategoryList.jsp"><img src="resources/images/ca_1.jpg" width="295" height="220" /></a></li>
            <li><a href="pages/front/CategoryList.jsp"><img src="resources/images/ca_2.jpg" width="295" height="220" /></a></li>
            <li><a href="pages/front/CategoryList.jsp"><img src="resources/images/ca_3.jpg" width="295" height="220" /></a></li>
            <li><a href="pages/front/CategoryList.jsp"><img src="resources/images/ca_4.jpg" width="295" height="220" /></a></li>
        </ul>
    </div>
    <!--Begin 热卖爆款商品 Begin-->
